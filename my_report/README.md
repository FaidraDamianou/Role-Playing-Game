...
<ul>Δημιουργώντας τον χαρκτήρα μου μέσω του Krita (διαστάσεις 32x32 px) και ακολουθώντας τα βήματα του [tutorial](https://learn.unity.com/tutorial/main-character-and-first-script?uv=2020.3&projectId=5c6166dbedbc2a0021b1bc7c) έβαλα στη θέση της Ρούμπι το Λάαμα μου. <img src="1.png" width="600" height="500">
  <ul><img src="2.png" width="600" height="500"></ul>
